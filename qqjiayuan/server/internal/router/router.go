	...
	api := r.Group("/api")
	{
		...
		authed := api.Group("/", jwtM)
		{
			...
			admin.GET("/garden-sign-stats", perm(db, "admin:access"), gardenH.AdminSignStats)
				...
				admin.GET("/xy-players", perm(db, "admin:access"), adminH.AdminXyPlayers)
				admin.GET("/xy-players/:id/detail", perm(db, "admin:access"), adminH.AdminXyPlayerDetail)
				admin.PUT("/xy-players/:id", perm(db, "admin:access"), adminH.AdminXyPlayerUpdate)
				admin.POST("/xy-players/:id/grant", perm(db, "admin:access"), adminH.AdminXyGrant)
				admin.POST("/xy-players/:id/ban", perm(db, "admin:access"), adminH.AdminXyBan)
				admin.POST("/xy-players/:id/mute", perm(db, "admin:access"), adminH.AdminXyMute)
				admin.DELETE("/xy-players/:id", perm(db, "admin:access"), adminH.AdminXyPlayerDelete)
				admin.GET("/xy-data/:table", perm(db, "admin:access"), adminH.AdminXyData)
				admin.POST("/xy-data/:table", perm(db, "admin:access"), adminH.AdminXyDataCreate)
				admin.PUT("/xy-data/:table/:id", perm(db, "admin:access"), adminH.AdminXyDataUpdate)
				admin.DELETE("/xy-data/:table/:id", perm(db, "admin:access"), adminH.AdminXyDataDelete)
				admin.GET("/xy-server", perm(db, "admin:access"), adminH.AdminXyServer)
				admin.POST("/xy-server/maintenance", perm(db, "admin:access"), adminH.AdminXyServerSet)
				admin.POST("/xy-server/exp2x", perm(db, "admin:access"), adminH.AdminXyExp2xSet)
				admin.GET("/xy-battles", perm(db, "admin:access"), adminH.AdminXyBattles)
				admin.DELETE("/xy-battles/:id", perm(db, "admin:access"), adminH.AdminXyBattleDelete)
				admin.GET("/xy-wallet", perm(db, "admin:access"), adminH.AdminXyWallet)
				admin.GET("/xy-stats", perm(db, "admin:access"), adminH.AdminXyStats)
				admin.POST("/xy-announce", perm(db, "admin:access"), adminH.AdminXyAnnounce)
				admin.POST("/xy-grant-all", perm(db, "admin:access"), adminH.AdminXyGrantAll)
