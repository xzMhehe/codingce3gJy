<template>
  <div>
    ...
    <div class="module-content">
      <p>当前G币：<b style="color:#e05a00">{{ bank.coins || 0 }}</b>　银行存款：<b style="color:#1a9e1a">{{ bank.balance || 0 }}</b></p>
      <p class="txt-fade">今日利息 {{ bank.rate || 0 }} G币{{ bank.interest_today ? '（已领取）' : '（待领取）' }}，存款按 0.5%/日 计息，可每日领一次。</p>
    ...
    <!-- 打工 -->
    <div class="module-title">打工·赚G币</div>
    <div class="module-content">
      <p class="txt-fade">今日已打工 <b style="color:#e05a00">{{ work.done || 0 }}</b>/{{ work.limit }} 次，剩余 {{ work.left || 0 }} 次，每次随机 5~15 G币。</p>
    ...
    <div class="module-content">
      ...
      <p>下注G币：<input type="text" v-model.number="lotAmt" size="6">
    ...
    <div class="module-content">
      <p class="txt-fade">花 {{ digCost }} G币挖一次宝，验证手气！当前G币 <b style="color:#e05a00">{{ coins }}</b>。</p>
    ...
    <div class="module-content">
      <p class="txt-fade">捐出G币帮助有需要的友友，做好事攒人品。</p>
