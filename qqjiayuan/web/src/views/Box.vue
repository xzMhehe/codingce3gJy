<template>
  <div>
    ...
    <div class="module-content">
      <a href="javascript:;" @click="$router.push('/profile')">编辑资料</a>.<a href="javascript:;" @click="$router.push('/face')">我的头像</a>.<a href="javascript:;" @click="$router.push('/profile')">个性昵称</a><br>
