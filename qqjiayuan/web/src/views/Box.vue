<template>
  <div>
    ...
    <div class="module-content">
      ...
      <a href="javascript:;" @click="$router.push('/profile')">收藏夹</a>.<a href="javascript:;" @click="tip('草稿箱')">草稿箱</a>.<a href="javascript:;" @click="$router.push('/fl')">福利院</a>.<a href="javascript:;" @click="tip('社区拍卖')">社区拍卖</a><br>
