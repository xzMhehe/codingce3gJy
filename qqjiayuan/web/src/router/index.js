...
const routes = [
  ...
  { path: '/kefu', name: 'kefu', component: () => import('../views/Kefu.vue') },
  { path: '/kefu/terms', name: 'kefuTerms', component: () => import('../views/Terms.vue') },
  { path: '/kefu/disclaimer', name: 'kefuDisclaimer', component: () => import('../views/Disclaimer.vue') },
  { path: '/kefu/help', name: 'kefuHelp', component: () => import('../views/Help.vue') },
  ...
  { path: '/family/:id/welfare', name: 'familyWelfare', component: () => import('../views/FamilyWelfare.vue') },
  ...
  { path: '/activities/list', name: 'activityList', component: () => import('../views/ActivityList.vue') },
