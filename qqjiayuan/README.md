...
> 致敬 2008 年腾讯 QQ家园 / 3GQQ 家园社区。当年天天签到、盖楼灌水、聊天交友的日子，用现代技术栈复刻回来。
> 2015年6月20日 QQ家园正式停止运营，但情怀不散。

基于 **MySQL + Gin(Go 1.26) + GORM + Vue 2.x + RBAC + 前后端分离** 实现的完整社区平台。
游戏（抢车位、好友买卖、魔法花园、阳光牧场、精武堂、召唤之王、纵横四海……）暂时不做，先把家园搭起来 —— 游戏大厅已留好入口（敬请期待）。
...
- 页面风格复刻自「家园演示源码」中的 3GQQ WAP 社区（蓝条、黄条、模块标题、小Q报时）。
